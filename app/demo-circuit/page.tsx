...
export default function DemoCircuit() {
  return (
    <main className="relative min-h-screen">
      <ASCIIBackground variant="circuit" opacity={0.6} speed={0.5} />
      ...
      <div className="fixed top-8 left-8 z-50 space-y-2">
        <div className="bg-white/90 backdrop-blur-sm rounded-lg border-2 border-gold p-4 shadow-xl">
          ...
          <div className="space-y-2 text-sm">
            ...
            <Link href="/demo-ocean" className="block px-3 py-2 border border-text-strong/20 rounded hover:bg-gold/10 transition-colors">
              Ocean Waves
            </Link>
          </div>
          <Link 
